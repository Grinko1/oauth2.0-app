...
@Component
public class CustomErrorHandlingFilter extends OncePerRequestFilter {

    private static final Logger logger = LoggerFactory.getLogger(CustomErrorHandlingFilter.class);
